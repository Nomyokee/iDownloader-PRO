...
@interface EnterPasscodeViewController_iPad()
...
@implementation EnterPasscodeViewController_iPad
...
- (IBAction)onOkButtonTap
{
    ...
    else if (![self.passcode isEqualToString:@""])
    {
        ...
        if (passcode == nil)
        {
            ...
            ReEnterPasscodeViewController_iPad *repvc = [[ReEnterPasscodeViewController_iPad alloc] initWithNibName:@"ReEnterPasscodeViewController_iPad" bundle:nil];
