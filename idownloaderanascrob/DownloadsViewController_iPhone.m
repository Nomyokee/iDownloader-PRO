//
//  DownloadsViewController_iPhone.m
//  iDownloadAllPro
//
...
@interface DownloadsViewController_iPhone()
...
@implementation DownloadsViewController_iPhone
         ...
         cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) 
    {
        ...
        UIButton *cancelDownloadButton = [[UIButton alloc] initWithFrame:CGRectMake(5, 13, 29, 29)];
        UILabel *downloadinfFileNameLabel = [[UILabel alloc] initWithFrame:CGRectMake(40, 8, 200, 20)];
        UIProgressView *downloadsProgressView = [[UIProgressView alloc] initWithFrame:CGRectMake(40, 35, 200, 20)];
        UILabel *progressLabel = [[UILabel alloc] initWithFrame:CGRectMake(245, 10, 70, 12)];
        UILabel *downloadsSpeedLabel = [[UILabel alloc] initWithFrame:CGRectMake(245, 35, 70, 10)];
        ...
        downloadinfFileNameLabel.font = [UIFont boldSystemFontOfSize:15.0f];
        ...
        progressLabel.tag = 3;
        progressLabel.font = [UIFont boldSystemFontOfSize:12.0f];
        progressLabel.backgroundColor = [UIColor clearColor];
        progressLabel.textColor = [UIColor redColor];
        
        downloadsSpeedLabel.tag = 4;
        downloadsSpeedLabel.font = [UIFont boldSystemFontOfSize:10.0f];
...
- (IBAction)onButtonClearTap:(UIButton *)sender 
{
    ...
    BOOL thereIsAtLeastOneFileDownloading;
